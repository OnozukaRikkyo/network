...
| ファイル | 内容 | DPI |
|---|---|---|
| `/home/sonozuka/network/data/d18_citation_network.graphml` | 有向グラフ（ノード・エッジ属性付き） | — |
| `/home/sonozuka/network/data/d18_citation_network.gexf` | 同上（Gephi 用） | — |
| `/home/sonozuka/network/data/d18_edges.csv` | エッジリスト CSV | — |
| `/home/sonozuka/network/data/d18_nodes.csv` | ノード属性 CSV | — |
| `/home/sonozuka/network/output/d18_citation_network.png` | ネットワーク図（最大WCC + 高次数サブグラフ） | 150 |
| `/home/sonozuka/network/output/d18_degree_distribution.png` | in/out/total 次数分布ヒストグラム | 150 |

※ネットワーク図・次数分布図は探索用（150 DPI）。論文用図は STEP 4/5 で別途生成（300 DPI）。
...
| ファイル | フルパス | 内容 |
|---|---|---|
| タイプ1 散布図 | `/home/sonozuka/network/output/fig_triplet1_scatter.png` | 横: A→B、縦: B→C（300 DPI）|
| タイプ2 散布図 | `/home/sonozuka/network/output/fig_triplet2_scatter.png` | 横: A→B、縦: C→B（300 DPI）|
| タイプ3 散布図 | `/home/sonozuka/network/output/fig_triplet3_scatter.png` | 横: B→A、縦: C→B（300 DPI）|
...
| ファイル | フルパス |
|---|---|
| ヒートマップ（3パネル） | `/home/sonozuka/network/output/fig_triplet_heatmap.png`（300 DPI）|
...
| ファイル | フルパス | 生成スクリプト |
|---|---|---|
| グラフ（GraphML） | `/home/sonozuka/network/data/d18_citation_network.graphml` | build_network.py（論文分析入力）|
| グラフ（GEXF） | `/home/sonozuka/network/data/d18_citation_network.gexf` | build_network.py（Gephi 用）|
...
| ネットワーク図 | `/home/sonozuka/network/output/d18_citation_network.png` | build_network.py（150 DPI・探索用）|
| 次数分布図 | `/home/sonozuka/network/output/d18_degree_distribution.png` | build_network.py（150 DPI・探索用）|
...
| コサイン類似度 CDF・Random ペア実装 | `/home/sonozuka/network/docs/sim_histogram.md` |
