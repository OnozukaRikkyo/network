...
| `data/triplets_type1_sim.csv` | CSV | タイプ1 + sim_A_B, sim_B_C | 類似度付きトリプレット |
| `data/triplets_type2_sim.csv` | CSV | タイプ2 + sim_A_B, sim_C_B | 類似度付きトリプレット |
| `data/triplets_type3_sim.csv` | CSV | タイプ3 + sim_B_A, sim_C_B | 類似度付きトリプレット |
